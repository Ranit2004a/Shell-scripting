...
main() {
    ...
    KEY_NAME="scriptkeypair"
    SUBNET_ID="subnet-0d084486fd8b15c0f"
    SECURITY_GROUP_IDS="sg-09280b818f0a56b15" #Add your security group IDs separated by space
    INSTANCE_NAME="EC2-by-shell-script"
